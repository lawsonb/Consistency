...
shinyServer(
  function(input, output) 
  {
    ...
    mycalc = function(type, weights)
    {
      ...
      temp = sapply(weights, function(x) 
        mytype_gen(N = x, type = type, true.mean, true.sd)) 
      ...
      result$true.mean = true.mean
      result$true.sd = true.sd
    ...
    output$meanplot = renderPlot({
      ...
      plot(Nvals(), results()$mean, xlab = "N", ylab = "mean value",
           ...
           abline(h = results()$true.mean, col = "green") 
   })
    ...
    output$varplot = renderPlot({
      ...
      plot(Nvals(), results()$var, xlab = "N", ylab = "variance value",
           ...
           abline(h = (results()$true.sd)^2, col = "green") 
    })
